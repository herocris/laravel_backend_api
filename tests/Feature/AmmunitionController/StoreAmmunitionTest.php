...
class StoreAmmunitionTest extends TestCase
{
    private User $admin;
    ...
    protected function setUp(): void
    {
        ...
        Ammunition::factory()->create(['description' => 'test_ammunition', 'logo' => 'test_logo.png']);
    }

    #[Test]
    public function store_creates_ammunition(): void
    {
        $payload = [
        ...
        $response = $this->postJson(route('ammunition.store'), $payload);
        $response->assertOk();
    ...
    public static function invalidAmmunitionDataProvider(): array
    {
        $invalidData = [
            'descripcion' => 'Droga de Prueba',
            'logo' => UploadedFile::fake()->image('droga_logo.png')
        ...
        return [
            ...
            'unique descripcion' => [
                array_merge($invalidData, ['descripcion' => 'test_ammunition']),
                'descripcion',
    ...
    #[Test]
    #[DataProvider('invalidAmmunitionDataProvider')]
    public function status_422_to_store_ammunition(array $data, string $error_field, string|array $error_message): void
    {
        $response = $this->postJson(route('ammunition.store'), $data);
    ...
    #[Test]
    public function unauthenticated_store_ammunition_returns_401(): void
    {
        Auth::logout();
